        ...
        <div className="relative w-full min-h-screen ">
            ...
            <div className="mx-auto px-4 md:px-0 max-w-5xl py-8 md:py-16">
                <h1 className="text-2xl md:text-5xl font-bold text-center text-white mb-8 md:mb-16">
                    Get Bonuses Worth ₹ 10000 after Joining this Workshop
                </h1>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {benifits.map((benifit, index) => (
                        <div key={index} className="relative bg-indigo-950 rounded-lg p-4 flex flex-col items-center justify-center w-full h-full gap-4 md:gap-8">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold">{benifit.title}</h2>
                        </div>
                    ))}
                </div>
